...
# save(fund, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/fund.Rdata')
# load(file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/fund.Rdata')
...
save(data, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.Rdata')
# save the fundamental data for future use
save(data.fund, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.fund.Rdata')
...
# get fundamental data
#load(file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.fund.Rdata')

# get pricing data
#load(file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.Rdata')
...
save(factors, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/factors.TV.Rdata')
...
# }
# 
# save.xlsx('D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out.xlsx',
#           out$quantiles, out$weights, out$ranking, out$hist.factor.quantiles, out$hist.ret.quantiles)
#########################################################################################################

#write.zoo(factors$TV$AVG, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/factors_TV_AVG.csv', index.name="Date", sep=',')
#write.zoo(next.month.ret, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/next_month_ret.csv',index.name="Date", sep=',')
#write.zoo(out$quantiles, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_quantiles.csv',index.name="Date", sep=',')
#write.csv(out$quantiles, 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_quantiles.csv')
# write.csv(out$weights, 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_weights.csv')
# write.csv(out$ranking, 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_ranking.csv')
# write.csv(out$hist.factor.quantiles, 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_hist_fact_quantiles.csv')
# write.csv(out$hist.ret.quantiles, 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/out_hist_ret_quantiles.csv')
...
for(i in tickers) {
  filename1 = paste("D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/", i, sep="")
...
#****************************************************************** 
save(data, sectors, factors.avg, next.month.ret, file="D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.factors.Rdata")
# remove Composite Average factor
# load("D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/data.factors.Rdata")
...
#filename = 'D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/factors_'
...
# save array all.data 
#save(all.data, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/all.data.Rdata')
#load(file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/all.data.Rdata')
...
setEPS()
layout(1:2)
postscript("D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/alpha_1.eps", horizontal = FALSE, onefile = FALSE, paper = "special",
           colormodel = "rgb") 
...
#****************************************************************** 
save(all.data, factor.covariance, specific.variance, file='D:/?Ȭw?j?ǤW?Ҹ???/Portfolio management 2015 Fall/MFM/risk.model.Rdata')
